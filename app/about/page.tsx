...
import Navbar from "@/components/Navbar"; // NEW: 引入 Navbar
...
export default function AboutPage() {
    return (
        <>
            <Navbar /> {/* NEW: 在页面顶部渲染 Navbar */}

            {/* 给主体加上 padding-top，避免被 fixed 头部遮挡，88 可按你的头部高度调整 */}
            <main id="about" className="relative overflow-hidden bg-[#FDFDFE] pt-[88px]">
                {/* ⭐ 背景星星装饰（20角星） */}
...
function Star20({ className = "" }: { className?: string }) {
    return (
        <svg
            ...
            fill="currentColor"
        >
            <polygon points="50,5 57,35 87,13 67,43 95,50 67,57 87,87 57,65 50,95 43,65 13,87 33,57 5,50 33,43 13,13 43,35" />
        </svg>
    );
}